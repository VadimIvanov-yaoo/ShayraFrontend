...
// node_modules/leo-profanity/dictionary/default.json
var require_default = __commonJS({
  "node_modules/leo-profanity/dictionary/default.json"(exports, module) {
    module.exports = [
      "2g1c",
      "acrotomophilia",
      "anal",
...
// node_modules/french-badwords-list/dist/object.js
var require_object = __commonJS({
  "node_modules/french-badwords-list/dist/object.js"(exports, module) {
...
// node_modules/french-badwords-list/dist/array.js
var require_array = __commonJS({
  "node_modules/french-badwords-list/dist/array.js"(exports, module) {
...
// node_modules/french-badwords-list/dist/regexp.js
var require_regexp = __commonJS({
  "node_modules/french-badwords-list/dist/regexp.js"(exports, module) {
...
// node_modules/french-badwords-list/dist/index.js
var require_dist = __commonJS({
  "node_modules/french-badwords-list/dist/index.js"(exports, module) {
    module.exports = { object: require_object(), array: require_array(), regex: require_regexp() };
  }
});

// node_modules/russian-bad-words/dist/russian-bad-words.esm.js
var russian_bad_words_esm_exports = {};
__export(russian_bad_words_esm_exports, {
  flatWords: () => flatWords,
  words: () => words
});
var нахуй, хуёво, нах, заебись, охуенно, adverbs, ёба, бля, блять, ёпт, interjections, блядь, пизда, пиздец, сука, хуй, долбоёб, наебалово, хуета, хуйня, заебумба, nouns, ёбнуть, ебать, ебаться, ебашить, заебать, пиздеть, проебать, спиздить, verbs, похуй, predicatives, words, flatten, flatWords;
var init_russian_bad_words_esm = __esm({
  "node_modules/russian-bad-words/dist/russian-bad-words.esm.js"() {
    нахуй = {
    ...
    adverbs = [заебись, нах, нахуй, охуенно, хуёво];
    ёба = {
      type: "interjection",
      interjection: "ёба"
    };
    ...
    interjections = [бля, блять, ёба, ёпт];
    блядь = {
      type: "noun",
    ...
    nouns = [блядь, долбоёб, заебумба, наебалово, пизда, пиздец, сука, хуета, хуй, хуйня];
    ёбнуть = {
    ...
    verbs = [ебать, ебаться, ебашить, ёбнуть, заебать, пиздеть, проебать, спиздить];
    похуй = {
      type: "predicative",
      predicative: "похуй"
    };
    predicatives = [похуй];
    words = [].concat(adverbs, interjections, nouns, verbs, predicatives);
    flatten = function flatten2(words2) {
      return words2.reduce(function(result, word) {
...
// node_modules/leo-profanity/src/index.js
var require_src = __commonJS({
  "node_modules/leo-profanity/src/index.js"(exports, module) {
    var LeoProfanity = {
    ...
    if (typeof module !== "undefined" && module.exports != null) {
      LeoProfanity.wordDictionary["en"] = require_default();
      try {
        LeoProfanity.wordDictionary["fr"] = require_dist().array;
      } catch (e) {
      }
      try {
        LeoProfanity.wordDictionary["ru"] = (init_russian_bad_words_esm(), __toCommonJS(russian_bad_words_esm_exports)).flatWords;
      } catch (e) {
      }
...
//# sourceMappingURL=leo-profanity.js.map
